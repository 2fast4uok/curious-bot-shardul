...
#
#     PHX_SERVER=true bin/curious_bot start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :curious_bot, CuriousBotWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :curious_bot, CuriousBot.Repo,
    # ssl: true,
    url: database_url,
  ...
  aws_ses_access_key =
    System.fetch_env!("AWS_SES_ACCESS_KEY") ||
      raise """
      environment variable AWS_SES_ACCESS_KEY is missing.
      """

  aws_ses_secret =
    System.fetch_env!("AWS_SES_SECRET") ||
      raise """
      environment variable AWS_SES_SECRET is missing.
      """

  config :curious_bot, CuriousBotWeb.Endpoint,
  ...
  config :curious_bot, CuriousBot.Mailer,
