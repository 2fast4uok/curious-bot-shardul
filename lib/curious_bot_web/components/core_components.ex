defmodule CuriousBotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CuriousBotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CuriousBotWeb.Gettext, "errors", msg, opts)
    end
  end
